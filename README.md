...
| ------- | ---- | -------- | -------- | -------- |
| **tree** (0 deps) | 0.657±0.026s | 0.669±0.178s | 1.558±0.042s | 3.668±0.416s |
| **wget** (6 deps) | 2.730±0.194s | 3.427±0.194s | 6.591±0.559s | 4.037±0.156s |
| **ffmpeg** (11 deps) | 3.210±0.170s | 3.356±0.078s | 7.844±0.250s | 19.000±0.183s |
<!-- BENCH:COLD:END -->
...
| ------- | ---- | -------- | -------- |
| **tree** (0 deps) | 0.009s | 0.012s | 0.250s |
| **wget** (6 deps) | 0.008s | 0.014s | 0.685s |
| **ffmpeg** (11 deps) | 0.033s | 0.019s | 3.313s |
<!-- BENCH:WARM:END -->
...
Apple Silicon (GitHub Actions macos-14), 2026-06-08. Auto-updated weekly via the [benchmark workflow](.github/workflows/benchmark.yml).
