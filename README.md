...
| ------- | ---- | -------- | -------- | -------- |
| **tree** (0 deps) | 0.681±0.041s | 2.812±0.039s | 1.694±0.102s | 3.440±0.323s |
| **wget** (6 deps) | 2.985±0.479s | 130.727±0.869s | 6.185±0.402s | 2.878±0.310s |
| **ffmpeg** (11 deps) | 2.919±0.224s | 100.896±0.347s | 6.866±1.533s | 6.483±0.875s |
<!-- BENCH:COLD:END -->
...
| ------- | ---- | -------- | -------- |
| **tree** (0 deps) | 0.010s | 0.013s | 0.377s |
| **wget** (6 deps) | 0.009s | 0.015s | 0.735s |
| **ffmpeg** (11 deps) | 0.024s | 0.021s | 3.100s |
<!-- BENCH:WARM:END -->
