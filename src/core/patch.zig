...
pub const patchTextFileHead = backend.patchTextFileHead;
pub const FileKind = backend.FileKind;
pub const classifyHead = backend.classifyHead;
pub const text_head_len = backend.text_head_len;
