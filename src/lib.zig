...
pub const install_service = @import("cli/install/service.zig");
...
pub const cli_vulns = @import("cli/vulns.zig");
pub const cli_vulns_identify = @import("cli/vulns/identify.zig");
...
pub const osv = @import("net/osv.zig");
...
pub const tui_cmd = @import("tui/cmd.zig");
...
pub const tui_tab_search = @import("tui/search_tab.zig");
